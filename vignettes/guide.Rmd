---
title: "[`fbseqStudies`](https://github.com/wlandau/fbseqStudies) package installation and usage guide"
author: Will Landau
date: 2015
...
vignette: >
  ...
  \VignetteIndexEntry{[`fbseqStudies`](https://github.com/wlandau/fbseqStudies) package installation and usage guide}
...
| `serial_runs()`  | Run various analyses, including a fully Bayesian one, of the @paschold dataset in a version of the software that makes no use of GPU computing at all. | 
